...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\ChIntro}\ifthenelse{\FaitMinitocs > 0}{\minitoc}{Minitoc}
\newpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\ChMaxent} \ifthenelse{\FaitMinitocs > 0}{\minitoc}{Minitoc}
\newpage
\input{chapters/Chapter-maxent}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\ChImogene} \ifthenelse{\FaitMinitocs > 0}{\minitoc}{Minitoc}
\newpage
\input{chapters/Chapter-imogene}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\ChTrichomes}\ifthenelse{\FaitMinitocs > 0}{\minitoc}{Minitoc}
\newpage
\input{chapters/Chapter-trichomes}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{\ChMuscle}\ifthenelse{\FaitMinitocs > 0}{\minitoc}{Minitoc}
\newpage
