...
%\includepdf[pages=-]{articles/muscle-sakakibaratext021211.pdf}
%\newpage
...
%\Annexes
%\Annex{Statistiques génomique}
\begin{appendices}
\chapter{Statistiques génomique}
\label{ann:statistiques}
\input{annexes/annexes-stat} 
\end{appendices}
%}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
