...
do
   ...
   for tmot in 5 6 7 8 9 10 11
   do
      mot="/home/santolin/these/files/droso/plaza/ovo_Q6/transfac-good/t$tmot/ovoQ6-wname.dat"
      ...
      do
         ...
         awk 'NR>1{print evol,tmot,tdet,$0}' evol="ovo_Q6" tmot=$tmot tdet=$t score/roc-infos.dat >> $ftarg
         if [ "$k" == "enhancers" ]; then
         ...
         awk 'NR>1{print evol,tmot,tdet,$0}' evol="ovo_Q6_no_cons" tmot=$tmot tdet=$t score/roc-infos.dat >> $ftarg
      done
   done
