...
#xlim <- c(-100,100)
t <- read.table('RES-STATISTICS-GAUGE/J.txt')
...
t <- read.table('RES-STATISTICS-GAUGE/J_nearest_neighbour.txt')
data <- c(-log10(-t$V1[t$V1<0]),log10(t$V1[t$V1>0]))
data <- t$V1[t$V1!=0]
#data <- log10(abs(t$V1))
#h <- hist(log10(abs(t$V1)), 
