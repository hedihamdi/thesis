...
ou (fig.~\ref{fig:modeles-correlations}d-e). Enfin, une dernière méthode
consiste à réaliser des mélanges de modèles afin de capturer des ensembles
distincts de corrélations (fig.~\ref{fig:modeles-correlations}f-g).
