...
\usepackage[pdftex, colorlinks = true
						, pdfstartview = FitH
						, linkcolor = black, citecolor = blue, urlcolor = blue, bookmarksnumbered = true, bookmarksopen = true , pdfpagelabels, pagebackref
						]{tlhypref}
...
\ifthenelse{\FaitNomenclature > 0}{
	\usepackage[refpage,french,intoc]{nomencl}  %intoc rajoute une ligne dans la toc
	\renewcommand{\nomname}{\fontfamily{ppl}\selectfont Principales notations utilisées} %Titre de la page
	\renewcommand{\pagedeclaration}[1]{~\dotfill\hyperpage{#1}}  %pour avoir des lignes de ... entre la description et le #page
	\renewcommand{\nomgroup}[1]{%
		\ifthenelse{\equal{#1}{A}}{\item[\textbf{\ChUnTitre}]}	  {
			\ifthenelse{\equal{#1}{B}}{\medskip\item[\textbf{\ChDeuxTitre}]}{
				\ifthenelse{\equal{#1}{C}}{\medskip\item[\textbf{\ChTroisTitre}]}{
					\ifthenelse{\equal{#1}{D}}{\medskip\item[\textbf{\ChQuatreTitre}]}{
				}}}}
		}
	\def\ChCourantTitre{\ifcase\value{chapter} \or A\or B\or C \or D\fi}
