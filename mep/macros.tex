%%%%%%%%%%%%%%%%%%%%%%%
%TITRE DES CHAPITRES
\newcommand{\ChUnTitre}{Titre du chapitre 1}
\newcommand{\ChDeuxTitre}{Chapitre 2}
\newcommand{\ChTroisTitre}{Chapitre 3}
\newcommand{\ChQuatreTitre}{Chapitre 4}
...
\newcommand{\becion}{condensation de Bose-Einstein\xspace}
\newcommand{\seqexp}{séquence expérimentale\xspace}
\newcommand{\cad}{c'est-à-dire\xspace}
\newcommand{\edp}{espace des phases\xspace}
\newcommand{\psd}{densité dans l'espace des phases\xspace}
...
\newcommand{\pmag}{piège magnétique\xspace}
\newcommand{\mMOT}{piège magnéto-optique miroir\xspace}
\newcommand{\UMOT}{\pmo en \textbf{U}\xspace}
\newcommand{\pmoq}{\pmo quadrupolaire\xspace}
\newcommand{\pmocryo}{\pmo cryogénique\xspace}

\newcommand{\bU}{\textbf{U}\xspace}
\newcommand{\bZ}{\textbf{Z}\xspace}
\newcommand{\bZrf}{\textbf{Z\ensuremath{_\text{rf}}}\xspace}

\newcommand{\aom}{modulateur acousto-optique\xspace}
\newcommand{\aoms}{modulateurs acousto-optiques\xspace}
\newcommand{\pmqc}{\ensuremath{\pm \Si{45}{\arcdeg}}}
\newcommand{\pqc}{\ensuremath{+\Si{45}{\arcdeg}}\xspace}
\newcommand{\mqc}{\ensuremath{-\Si{45}{\arcdeg}}\xspace}
\newcommand{\mathbold}{\boldmath}

\newcommand{\etal}{\textit{et al.}\xspace}
\newcommand{\tn}{Thomas Nirrengarten\xspace}

\newcommand{\ltp}{\textit{loose trap}\xspace}
\newcommand{\ttp}{\textit{tight trap}\xspace}

\newcommand{\tce}{taux de collisions élastiques\xspace}

\newcommand{\tfd}{théorème fluctuation-dissipation\xspace}
\newcommand{\cem}{champ électromagnétique\xspace}
\newcommand{\ff}{\textit{flux-flow}\xspace}
