%%%%%%%%%%%%%%%%%%%%%%%
%TITRE DES CHAPITRES
\newcommand{\ChTestTitre}{Chapitre d'exemples}
\newcommand{\ChUnTitre}{Modèles d'accrochage des Facteurs de Transcription à l'ADN.}
\newcommand{\ChDeuxTitre}{{\em Imogene}: un algorithme d'identification de motifs et de modules de régulation transcriptionnelle}
\newcommand{\ChTroisTitre}{Étude de la différenciation épidermale chez la drosophile}
\newcommand{\ChQuatreTitre}{Étude de la différenciation musculaire chez la souris}
...
\newcommand{\dromel}{\textit{Drosophila Melanogaster}\xspace}
